...
def jacobi_forward(
    ...
    if prefill_phase: # prefill phase, just compute the keys & values of prompt
        ...
        logits = logits.to(self.model.device).float()
        ...
        return next_decoder_cache, first_correct_token, logits
        ...
        return accurate_n_gram, first_correct_token, iter_counter, accurate_length, logits
...
def jacobi_forward_profiling(
    ...
    if prefill_phase: # prefill phase, just compute the keys & values of prompt
        ...
        return jacobian_trajectory[:-1], next_point, first_correct_token, iter_counter, logits